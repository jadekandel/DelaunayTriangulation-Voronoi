            ...
            for edge2 in edgeList2:
              ...
              if edge1Point1.getX() == edge2Point1.getX() and edge1Point1.getY() == edge2Point1.getY():
                if edge1Point2.getX() == edge2Point2.getX() and edge1Point2.getY() == edge2Point2.getY():
                  ...
                  line.setOutline(color_rgb(255, 255, 153))
                  line.draw(win)
...
def main():
  ...
  window = GraphWin("pattern.ppm", 1250, 700)
  window.setBackground(color_rgb(51, 170, 0))
  
  #create points:
  pointList=[]
  for i in range (1000):
    pointList.append(Point(random.randint(0,1250),random.randint(0,750)))
